...
@interface QLLogonViewController ()<UIScrollViewDelegate,UIPickerViewDelegate,UIPickerViewDataSource,UITextFieldDelegate>
...
@implementation QLLogonViewController
{
